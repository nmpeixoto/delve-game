...
function createRuntime(seed) {
  ...
  function captureSnapshot() {
    ...
    return {
      ...
      x: p.x, y: p.y,
      class: p.class,
      weapon: p.weapon ? { atk: p.weapon.atk, sym: p.weapon.sym, name: p.weapon.name } : null,
      armor: p.armor ? { def: p.armor.def, name: p.armor.name } : null,
      ...
      emergencyOpen: emergencyOverlay && emergencyOverlay.style.display === 'flex',
      shrineOpen: shrineOverlay && (shrineOverlay.style.display === 'flex' || shrineOverlay.style.display === 'block'),
